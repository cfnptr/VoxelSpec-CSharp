...
using OpenVoxelSpec.Blocks.Containers.Fragments;
...
namespace OpenVoxelSpec.Blocks.Generators.Surfaces
{
    ...
    public struct SurfaceInfo
    {
        ...
        /// </summary>
        public IFragment[] stalactites;

        public static readonly IFragment ExtremeStalactite = new Fragment(0, 3, 0, new Block[4][][]
        {
        ...
        public static readonly IFragment LongStalactite = new Fragment(0, 2, 0, new Block[3][][]
        {
            new Block[1][]{ new Block[1]{ BlockType.Stalactite28, }, },
            new Block[1][]{ new Block[1]{ BlockType.Stalactite48, }, },
            new Block[1][]{ new Block[1]{ BlockType.Stalactite68, }, },
        });
        public static readonly IFragment MediumStalactite = new Fragment(0, 1, 0, new Block[2][][]
        {
            new Block[1][]{ new Block[1]{ BlockType.Stalactite28, }, },
            new Block[1][]{ new Block[1]{ BlockType.Stalactite48, }, },
        });
        public static readonly IFragment ShortStalactite = new Fragment(0, 0, 0, new Block[1][][]
        {
            new Block[1][]{ new Block[1]{ BlockType.Stalactite28, }, },
        });
        /// <summary>
        ...
        /// </summary>
        public static readonly SurfaceInfo Default = new SurfaceInfo()
        {
